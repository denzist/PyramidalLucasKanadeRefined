#include"optical_flow/include/matrix.h"

//--------------------------------------------------------------------------------------------------------------------------------------------------------------------
// Matix and Convolution
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
// retuns the value at the x, y element of matrix
// if x and  y out of borders returns T()
template<class T>
...
//get bilinear interpolation for subpixel values
template<class T>
...
// also the value out matrix bounds is defined as 0.
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------
